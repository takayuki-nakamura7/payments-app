...
@section('content')
    <div class="container">
                    ...
                    <div class="card-body">
                        <form action="{{ route('shops_filter') }}" method="get">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" id="zipCodeInput" name="zip_code" value="{{ $zip_code }}">
                            </div>
        ...
        <div class="row justify-content-center">
            <div class="col-md-10">
                <div class="card">
                    <div class="card-header">ショップ一覧（{{ $shops->count() }}件）<a class="btn" href="{{ route('shops') }}" role="button">フィルター解除</a></div></div>
