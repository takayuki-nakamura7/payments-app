                ...
                <div class="card-body">
                    <form action="{{ route('shops_update', ['id' => $shop->id]) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" id="zipCodeInput" name="zip_code" value="{{ $shop->zip_code }}">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" id="address1Input" name="address1" value="{{ $shop->address1 }}">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" id="address2Input" name="address2" value="{{ $shop->address2 }}">
                        </div>
                        <button class="btn btn-primary mb-10">登録</button>
                    </form>
