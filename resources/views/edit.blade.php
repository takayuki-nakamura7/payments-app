            ...
            <div class="col-md-10">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('update', ['id' => $payment->id]) }}" method="post">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control is-invalid" id="priceInput" name="price"
                                           placeholder="0" value="{{ $payment->price }}">
                                    @if ($errors->has('customer'))
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select class="custom-select" id="priceOperatorSelect" name="method">
                                    <option value="クレジットカード" @if("クレジットカード" === $payment->method) selected @endif>
                                        クレジットカード
                                    </option>
                        ...
                        <form style="margin-top:10px;" action="{{ route('welcome') }}" method="get">
